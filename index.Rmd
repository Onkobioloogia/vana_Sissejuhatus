...
```{r viited, echo=FALSE, cache=FALSE}
opts_chunk$set(message=FALSE)
library(knitcitations)
bib <- read.bibtex('~/Dropbox/Onkobioloogia/viited.bib')
```
...
```{r haigestumus, echo=FALSE, fig.align = 'center', cache=FALSE}
kasvajad <- read.csv("~/Dropbox/Onkobioloogia/data/Kasvajad_haigestumus_2000-9.csv", header = TRUE)
# load libraries
library(quantmod)
library(magrittr)
library(ggplot2)
...
```{r paikmed, echo=FALSE, warning=FALSE,  fig.width=12, fig.align = 'center'}
...
---
### Viited
```{r bibliograafia, results="asis", echo=FALSE, cache=FALSE}
